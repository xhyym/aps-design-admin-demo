...
<style scoped>
.member-cell { display: flex; align-items: center; gap: 10px; }.member-avatar { display: grid; width: 31px; height: 31px; place-items: center; border-radius: 50%; background: #e9eef5; color: #314b69; font-size: var(--aps-text-sm); font-weight: var(--aps-font-weight-heading); }.member-cell strong, .member-cell span { display: block; }.member-cell strong { color: var(--aps-ink); font-size: var(--aps-text-base); font-weight: var(--aps-font-weight-strong); }.member-cell div > span { margin-top: 2px; color: var(--aps-faint); font-size: var(--aps-text-xs); }.drawer-form { display: grid; gap: var(--aps-form-gap); }.form-error { margin: -3px 0 0; color: var(--aps-red); font-size: var(--aps-text-sm); }
</style>
