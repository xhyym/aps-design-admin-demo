...
<style scoped>
.number-input-view { max-width: 960px; }.showcase-heading { display: flex; align-items: flex-start; justify-content: space-between; gap: 20px; margin-bottom: 22px; }.showcase-heading h2, .showcase-heading p { margin: 0; }.showcase-heading h2 { color: var(--aps-ink); font-size: var(--aps-text-lg); font-weight: var(--aps-font-weight-heading); letter-spacing: -.02em; }.showcase-heading p { max-width: 62ch; margin-top: 7px; color: var(--aps-muted); font-size: var(--aps-text-sm); line-height: 1.6; }.number-demo-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 16px; }.number-demo-field { display: grid; gap: 7px; color: var(--aps-muted); font-size: var(--aps-text-sm); font-weight: var(--aps-font-weight-primary); }.number-demo-field small { color: var(--aps-faint); font-size: var(--aps-text-xs); font-weight: 400; line-height: 1.5; }.change-status { min-height: 20px; margin: 14px 0 0; color: var(--aps-faint); font-size: var(--aps-text-xs); }.quota-layout { display: grid; grid-template-columns: minmax(0, .9fr) minmax(0, 1.1fr); align-items: end; gap: 16px; }.keyboard-note { display: grid; min-height: 92px; align-content: center; gap: 5px; padding: 16px 18px; border: 1px solid var(--aps-line-soft); border-radius: 12px; background: var(--aps-surface-soft); }.keyboard-note strong { color: var(--aps-ink); font-size: var(--aps-text-sm); font-weight: var(--aps-font-weight-strong); }.keyboard-note span { color: var(--aps-faint); font-size: var(--aps-text-xs); line-height: 1.5; }@media (max-width: 700px) { .showcase-heading { flex-direction: column; }.number-demo-grid, .quota-layout { grid-template-columns: 1fr; } }
</style>
