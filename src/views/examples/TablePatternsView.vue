...
<style scoped>
.table-patterns-page { display: grid; align-content: start; gap: var(--aps-page-stack-gap); }.table-pattern-intro h1, .table-pattern-intro p { margin: 0; }.table-pattern-intro h1 { color: var(--aps-ink); font-size: var(--aps-text-xl); font-weight: var(--aps-font-weight-heading); letter-spacing: -.025em; }.table-pattern-intro p { margin-top: 7px; color: var(--aps-muted); font-size: var(--aps-text-sm); line-height: 1.65; }.table-pattern-card { overflow: hidden; border-color: var(--aps-line); }.table-pattern-caption { color: var(--aps-muted); font-size: var(--aps-text-sm); font-weight: var(--aps-font-weight-primary); }.completion-value, .capacity-value { color: var(--aps-ink); font-variant-numeric: tabular-nums; }.release-conclusion { color: var(--aps-ink); font-weight: var(--aps-font-weight-primary); }.table-patterns-page :deep(.is-risk-row) { background: rgba(201, 78, 72, .035); }.table-patterns-page :deep(.is-risk-row:hover) { background: rgba(201, 78, 72, .07); }.table-patterns-page :deep(td.is-risk-cell) { color: #a0342e; font-weight: var(--aps-font-weight-primary); }.table-patterns-page :deep(td.is-release-cell) { background: var(--aps-surface-soft); }
</style>
