...
<style scoped>
.advanced-selection-view { display: grid; gap: 28px; }.showcase-heading { display: flex; align-items: flex-start; justify-content: space-between; gap: 20px; margin-bottom: 22px; }.showcase-heading h2, .showcase-heading p { margin: 0; }.showcase-heading h2 { color: var(--aps-ink); font-size: var(--aps-text-lg); font-weight: 720; }.showcase-heading p { max-width: 65ch; margin-top: 7px; color: var(--aps-muted); font-size: var(--aps-text-sm); line-height: 1.6; }.showcase-heading > span { flex: 0 0 auto; padding: 4px 8px; border-radius: 6px; background: var(--aps-surface-soft); color: var(--aps-faint); font-size: var(--aps-text-xs); font-weight: 650; }.selection-summary, .member-summary, .panel-selection-summary { display: flex; align-items: center; justify-content: space-between; gap: 18px; margin-top: 20px; padding-top: 16px; border-top: 1px solid var(--aps-line-soft); }.selection-summary div { display: grid; min-width: 0; gap: 3px; }.selection-summary strong, .member-summary strong { color: var(--aps-ink); font-size: var(--aps-text-sm); font-weight: 680; }.selection-summary span, .panel-selection-summary span { overflow: hidden; color: var(--aps-muted); font-size: var(--aps-text-xs); text-overflow: ellipsis; white-space: nowrap; }.member-summary > div { display: flex; flex-wrap: wrap; justify-content: flex-end; gap: 7px; }.create-select-grid { display: grid; grid-template-columns: minmax(0, 1fr) minmax(180px, .42fr); gap: 18px; }.create-select-grid label, .topic-preview { display: grid; align-content: start; gap: 8px; }.create-select-grid label > span, .topic-preview strong { color: var(--aps-muted); font-size: var(--aps-text-sm); font-weight: 650; }.topic-preview { min-height: var(--aps-control-height); padding: 12px 14px; border: 1px solid var(--aps-line-soft); border-radius: 10px; background: var(--aps-surface-soft); }.topic-preview > span { overflow: hidden; color: var(--aps-ink); font-size: var(--aps-text-sm); font-weight: 680; text-overflow: ellipsis; white-space: nowrap; }.selection-control-grid { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 16px; }.selection-control-field { display: grid; min-width: 0; align-content: start; gap: 8px; padding: 14px; border: 1px solid var(--aps-line-soft); border-radius: 12px; background: var(--aps-surface-soft); }.selection-control-field > span { color: var(--aps-ink); font-size: var(--aps-text-sm); font-weight: 680; }.selection-control-field > small { min-height: 36px; color: var(--aps-faint); font-size: var(--aps-text-xs); line-height: 1.55; }@media (max-width: 920px) { .selection-control-grid { grid-template-columns: 1fr; }.selection-control-field > small { min-height: 0; } }@media (max-width: 720px) { .showcase-heading, .selection-summary, .member-summary, .panel-selection-summary { align-items: flex-start; flex-direction: column; }.member-summary > div { justify-content: flex-start; }.create-select-grid { grid-template-columns: 1fr; } }
</style>
