...
<style scoped>
.image-viewer-page { display: grid; min-height: 0; align-content: start; gap: var(--aps-page-stack-gap); }.image-viewer-heading { display: flex; align-items: end; justify-content: space-between; gap: 20px; }.image-viewer-heading h1, .image-viewer-heading p, .image-viewer-card-heading h2, .image-viewer-card-heading p { margin: 0; }.image-viewer-heading h1 { color: var(--aps-ink); font-size: var(--aps-text-2xl); font-weight: var(--aps-font-weight-heading); letter-spacing: -.035em; }.image-viewer-heading p { max-width: 760px; margin-top: 8px; color: var(--aps-muted); font-size: var(--aps-text-sm); line-height: 1.65; }.image-viewer-card { display: grid; gap: 22px; }.image-viewer-card-heading { display: flex; align-items: start; justify-content: space-between; gap: 16px; }.image-viewer-card-heading h2 { color: var(--aps-ink); font-size: var(--aps-text-lg); font-weight: var(--aps-font-weight-heading); }.image-viewer-card-heading p { max-width: 720px; margin-top: 6px; color: var(--aps-muted); font-size: var(--aps-text-sm); line-height: 1.6; }.image-viewer-card-heading > span { flex: 0 0 auto; color: var(--aps-faint); font-size: var(--aps-text-xs); font-weight: var(--aps-font-weight-primary); }.image-viewer-grid { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 12px; }.image-viewer-grid > button { display: grid; min-width: 0; gap: 8px; padding: 0; border: 1px solid transparent; border-radius: 12px; background: transparent; color: var(--aps-muted); text-align: left; }.image-viewer-grid > button:hover, .image-viewer-grid > button.is-active { color: var(--aps-blue); }.image-viewer-grid > button.is-active :deep(.app-image) { outline: 2px solid var(--aps-blue); outline-offset: 2px; }.image-viewer-grid > button:focus-visible { outline: 2px solid var(--aps-blue); outline-offset: 3px; }.image-viewer-grid :deep(.app-image) { min-height: 132px; border-radius: 10px; }.image-viewer-grid > button > span { overflow: hidden; padding-inline: 2px; font-size: var(--aps-text-sm); font-weight: var(--aps-font-weight-primary); text-overflow: ellipsis; white-space: nowrap; }.image-viewer-status { min-height: 20px; margin: 0; color: var(--aps-faint); font-size: var(--aps-text-xs); line-height: 1.5; }@media (max-width: 900px) { .image-viewer-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); } }.image-viewer-heading { align-items: start; }@media (max-width: 600px) { .image-viewer-heading { flex-direction: column; }.image-viewer-heading .app-button-control { width: 100%; }.image-viewer-card-heading > span { display: none; } }
</style>
