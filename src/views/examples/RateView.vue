...
<style scoped>
.rate-view { max-width: 960px; }.showcase-heading { display: flex; align-items: flex-start; justify-content: space-between; gap: 20px; margin-bottom: 22px; }.showcase-heading h2, .showcase-heading p { margin: 0; }.showcase-heading h2 { color: var(--aps-ink); font-size: var(--aps-text-lg); font-weight: 720; letter-spacing: -.02em; }.showcase-heading p { max-width: 62ch; margin-top: 7px; color: var(--aps-muted); font-size: var(--aps-text-sm); line-height: 1.6; }.rate-demo-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 1px; overflow: hidden; border: 1px solid var(--aps-line-soft); border-radius: 12px; background: var(--aps-line-soft); }.rate-demo-item { display: grid; min-height: 158px; align-content: center; gap: 9px; padding: 18px; background: var(--aps-surface); }.rate-demo-item > strong { color: var(--aps-ink); font-size: var(--aps-text-sm); font-weight: 680; }.rate-demo-item > span { color: var(--aps-faint); font-size: var(--aps-text-xs); line-height: 1.5; }.rate-status { min-height: 20px; margin: 14px 0 0; color: var(--aps-faint); font-size: var(--aps-text-xs); }.readonly-rate-row { display: flex; flex-wrap: wrap; gap: 32px; }.readonly-rate-row > div { display: grid; gap: 5px; }.readonly-rate-row span { color: var(--aps-muted); font-size: var(--aps-text-sm); font-weight: 650; }@media (max-width: 700px) { .showcase-heading { flex-direction: column; }.rate-demo-grid { grid-template-columns: 1fr; } }
</style>
