...
<style scoped>
.template-primary { min-width: 0; }.template-primary strong, .template-primary small { display: block; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }.template-primary strong { color: var(--aps-ink); font-size: var(--aps-text-sm); font-weight: 680; }.template-primary small, .attribute-count { margin-top: 3px; color: var(--aps-faint); font-size: var(--aps-text-xs); }.template-code { color: var(--aps-muted); font-family: var(--aps-font); font-size: var(--aps-text-sm); }.attribute-summary { display: block; overflow: hidden; color: var(--aps-ink); text-overflow: ellipsis; white-space: nowrap; }.attribute-count { display: block; }.numeric { color: var(--aps-ink); font-variant-numeric: tabular-nums; }.template-form { display: grid; gap: 22px; }.template-form-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; }.field-hint { display: inline-grid; width: 17px; height: 17px; place-items: center; margin: 0; padding: 0; border: 1px solid var(--aps-line); border-radius: 50%; background: var(--aps-surface-soft); color: var(--aps-muted); font: 650 11px/1 var(--aps-font); cursor: help; }.field-hint:hover, .field-hint:focus-visible { border-color: var(--aps-blue); background: var(--aps-blue-soft); color: var(--aps-blue); outline: none; }.attributes-panel { display: grid; gap: 14px; padding-top: 4px; }.attributes-heading { display: flex; align-items: flex-start; justify-content: space-between; gap: 16px; }.attributes-heading h3, .attributes-heading p { margin: 0; }.attributes-heading h3 { color: var(--aps-ink); font-size: var(--aps-text-md); font-weight: 700; }.attributes-heading p { margin-top: 4px; color: var(--aps-muted); font-size: var(--aps-text-sm); }.attribute-list { display: grid; gap: 10px; }.attribute-row { display: grid; grid-template-columns: 34px minmax(120px, .75fr) minmax(220px, 1.5fr) 34px; align-items: center; gap: 10px; }.attribute-index { color: var(--aps-faint); font-family: var(--aps-font); font-size: var(--aps-text-xs); font-variant-numeric: tabular-nums; text-align: center; }.form-error { margin: -8px 0 0; color: var(--aps-red); font-size: var(--aps-text-sm); }@media (max-width: 680px) { .template-form-grid { grid-template-columns: 1fr; gap: 12px; }.attributes-heading { align-items: stretch; flex-direction: column; }.attribute-row { grid-template-columns: 26px minmax(0, 1fr) 34px; }.attribute-row :deep(.app-input-tag) { grid-column: 2 / -1; } }
</style>
