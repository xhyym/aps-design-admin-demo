...
<style scoped>
.order-summary { color: var(--aps-muted); font-size: var(--aps-text-sm); }.order-number { color: var(--aps-blue); font-size: var(--aps-text-sm); font-weight: var(--aps-font-weight-strong); }.order-number:hover { color: var(--aps-blue-hover); text-decoration: underline; text-underline-offset: 3px; }.customer-cell { display: grid; gap: 2px; }.customer-cell strong { color: var(--aps-ink); font-size: var(--aps-text-sm); font-weight: var(--aps-font-weight-strong); }.customer-cell span { color: var(--aps-faint); font-size: var(--aps-text-xs); }.product-cell { color: var(--aps-ink); font-size: var(--aps-text-sm); }.amount-cell { color: var(--aps-ink); font-size: var(--aps-text-sm); font-variant-numeric: tabular-nums; }.amount-filter { display: flex; min-width: 246px; align-items: center; gap: 7px; }.amount-filter > span { color: var(--aps-faint); font-size: var(--aps-text-xs); }.amount-filter :deep(.app-number-input) { min-width: 0; flex: 1; }
</style>
