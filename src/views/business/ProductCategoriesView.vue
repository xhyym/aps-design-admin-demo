...
<style scoped>
.category-primary { min-width: 0; }.category-primary strong, .category-primary small { display: block; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }.category-primary strong { color: var(--aps-ink); font-size: var(--aps-text-sm); font-weight: 680; }.category-primary small { margin-top: 3px; color: var(--aps-faint); font-size: var(--aps-text-xs); }.category-code { color: var(--aps-muted); font-family: var(--aps-font); font-size: var(--aps-text-sm); }.numeric { color: var(--aps-ink); font-variant-numeric: tabular-nums; }.category-form { display: grid; gap: var(--aps-form-gap); }.category-form-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 12px; }.form-error { margin: -3px 0 0; color: var(--aps-red); font-size: var(--aps-text-sm); }@media (max-width: 680px) { .category-form-grid { grid-template-columns: 1fr; } }
</style>
