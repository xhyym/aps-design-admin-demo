...
<style scoped>
.detail-topbar { display: flex; align-items: center; justify-content: space-between; gap: 12px; }.detail-topbar-actions { display: inline-flex; flex-wrap: wrap; justify-content: flex-end; gap: 8px; }.back-link { display: inline-flex; min-height: 32px; align-items: center; gap: 5px; color: var(--aps-muted); font-size: var(--aps-text-sm); font-weight: var(--aps-font-weight-primary); }.back-link:hover { color: var(--aps-blue); }.order-overview :deep(.card-content) { display: flex; align-items: flex-end; justify-content: space-between; gap: 24px; }.order-overview-main p, .order-overview-main h1, .order-overview-main span { margin: 0; }.order-overview-main p { color: var(--aps-muted); font-size: var(--aps-text-sm); }.order-overview-main h1 { margin-top: 6px; color: var(--aps-ink); font-size: 24px; font-weight: var(--aps-font-weight-heading); letter-spacing: -.035em; }.order-overview-main span { display: block; margin-top: 8px; color: var(--aps-muted); font-size: var(--aps-text-sm); }.order-overview-status { display: grid; justify-items: end; gap: 11px; }.order-overview-status strong { color: var(--aps-ink); font-size: 24px; font-weight: var(--aps-font-weight-heading); font-variant-numeric: tabular-nums; }.detail-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: var(--aps-page-stack-gap); }.section-heading h2, .section-heading p { margin: 0; }.section-heading h2, .item-heading h2 { color: var(--aps-ink); font-size: var(--aps-text-lg); font-weight: var(--aps-font-weight-heading); letter-spacing: -.02em; }.section-heading p { margin-top: 5px; color: var(--aps-muted); font-size: var(--aps-text-sm); }.section-heading + :deep(.app-descriptions), .section-heading + :deep(.app-timeline) { margin-top: 22px; }.item-heading { display: flex; min-height: 62px; align-items: center; justify-content: space-between; gap: 12px; padding: 0 var(--aps-table-cell-padding); border-bottom: 1px solid var(--aps-line); }.item-heading h2 { margin: 0; }.item-heading span { color: var(--aps-muted); font-size: var(--aps-text-sm); }.order-items article { display: grid; grid-template-columns: 40px minmax(0, 1fr) auto 112px; align-items: center; gap: 14px; min-height: 78px; padding: 0 var(--aps-table-cell-padding); border-bottom: 1px solid var(--aps-line-soft); color: var(--aps-muted); font-size: var(--aps-text-sm); }.order-items article:last-child { border-bottom: 0; }.item-symbol { display: grid; width: 36px; height: 36px; place-items: center; border-radius: 10px; background: var(--aps-blue-soft); color: var(--aps-blue); }.item-copy { min-width: 0; }.item-copy strong, .item-copy span { display: block; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }.item-copy strong { color: var(--aps-ink); font-size: var(--aps-text-sm); font-weight: var(--aps-font-weight-strong); }.item-copy span { margin-top: 3px; color: var(--aps-faint); font-size: var(--aps-text-xs); }.order-items article > strong { color: var(--aps-ink); font-size: var(--aps-text-sm); text-align: right; font-variant-numeric: tabular-nums; }@media (max-width: 760px) { .detail-topbar { align-items: flex-start; flex-direction: column; }.detail-topbar-actions { width: 100%; justify-content: flex-start; }.detail-grid { grid-template-columns: 1fr; }.order-overview :deep(.card-content) { align-items: flex-start; flex-direction: column; }.order-overview-status { justify-items: start; }.order-items article { grid-template-columns: 36px minmax(0, 1fr) auto; }.order-items article > strong { grid-column: 2 / -1; text-align: left; } }
</style>
