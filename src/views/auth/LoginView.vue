...
.context-header { display: inline-flex; align-items: center; gap: 10px; color: var(--aps-ink); font-size: 15px; font-weight: 760; letter-spacing: -0.03em; }
...
.context-kicker { margin: 0 0 14px; color: var(--aps-muted); font-size: 13px; font-weight: 650; }
h1 { max-width: 470px; margin: 0; color: var(--aps-ink); font-size: clamp(30px, 2.5vw, 38px); font-weight: 720; letter-spacing: -0.05em; line-height: 1.12; }
...
.window-title { color: var(--aps-ink); font-weight: 680; }.window-status { display: inline-flex; align-items: center; gap: 6px; }.window-status i { width: 6px; height: 6px; border-radius: 50%; background: var(--aps-green); }
...
.login-heading h2 { margin: 0; color: var(--aps-ink); font-size: 27px; font-weight: 720; letter-spacing: -0.04em; line-height: 1.2; }
.login-heading p { margin: 9px 0 0; color: var(--aps-muted); font-size: 13px; }
.login-form { display: grid; gap: 12px; margin-top: 30px; }
.text-action { min-height: 24px; padding: 0; border: 0; background: transparent; color: var(--aps-blue); font-size: 12px; font-weight: 620; }
...
.demo-credentials strong { color: #3a3a3e; font-weight: 680; }
.demo-credentials span { display: inline-flex; gap: 5px; }
code { color: var(--aps-ink); font-family: var(--aps-font); font-size: 12px; font-weight: 650; }
